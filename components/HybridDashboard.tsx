...
import { formatCurrency, formatNumber, formatPercentage } from '@/lib/hybridCalculations';
import {
  LineChart,
  Line,
  AreaChart,
...
export default function HybridDashboard({ results, chartData }: HybridDashboardProps) {
  ...
  const revenueCompositionData = [
    { name: 'Base Revenue', value: results.revenueComposition.base, color: '#3b82f6' },
    { name: 'User Revenue', value: results.revenueComposition.users, color: '#22c55e' },
    { name: 'AI Revenue', value: results.revenueComposition.ai, color: '#f59e0b' },
    { name: 'Add-on Revenue', value: results.revenueComposition.addons, color: '#8b5cf6' },
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-4 rounded-lg border border-green-200 dark:border-green-700">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-green-600 dark:text-green-400">Peak MRR</p>
        ...
        <div className="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-4 rounded-lg border border-purple-200 dark:border-purple-700">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-purple-600 dark:text-purple-400">Max Tenants</p>
        ...
        <div className="chart-container">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Tenant Growth Rate</span>
              <span className="text-lg font-bold text-primary-600 dark:text-primary-400">
                {formatPercentage(results.growthMetrics.tenantGrowthRate)}/mo
              </span>
            </div>
            <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">User Growth Rate</span>
            ...
            <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">LTV</span>
              <span className="text-lg font-bold text-purple-600 dark:text-purple-400">
                {formatCurrency(results.growthMetrics.ltv)}
              </span>
            </div>
            <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">CAC</span>
      ...
      <div className="chart-container">
        ...
        <ResponsiveContainer width="100%" height={400}>
          <BarChart data={stackedRevenueData}>
            ...
            <Legend />
            <Bar dataKey="baseRevenue" stackId="revenue" fill="#3b82f6" name="Base Revenue" />
            <Bar dataKey="userRevenue" stackId="revenue" fill="#22c55e" name="User Revenue" />
            <Bar dataKey="aiRevenue" stackId="revenue" fill="#f59e0b" name="AI Revenue" />
            <Bar dataKey="addonRevenue" stackId="revenue" fill="#8b5cf6" name="Add-on Revenue" />
          </BarChart>
        </ResponsiveContainer>
      </div>
      ...
      {results.breakEvenMonth && (
        <div className="bg-success-50 dark:bg-success-900/20 border border-success-200 dark:border-success-800 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <div className="text-sm text-success-600 dark:text-success-400">Break-Even Month</div>
              <div className="text-2xl font-bold text-success-800 dark:text-success-200">
                Month {results.breakEvenMonth}
              </div>
            </div>
            <div>
              <div className="text-sm text-success-600 dark:text-success-400">Tenants at Break-Even</div>
              <div className="text-2xl font-bold text-success-800 dark:text-success-200">
                {formatNumber(results.monthlyData[results.breakEvenMonth - 1]?.tenants || 0)}
              </div>
            </div>
            <div>
              <div className="text-sm text-success-600 dark:text-success-400">MRR at Break-Even</div>
              <div className="text-2xl font-bold text-success-800 dark:text-success-200">
                {formatCurrency(results.monthlyData[results.breakEvenMonth - 1]?.mrr || 0)}
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <span className="text-blue-700 dark:text-blue-300">Current Annual Run Rate</span>
          ...
          <div className="w-full bg-blue-200 dark:bg-blue-800 rounded-full h-4">
            <div
              ...
              style={{ width: `${Math.min((results.peakMRR * 12) / 1000000 * 100, 100)}%` }}
            ></div>
          </div>
          <div className="flex justify-between text-sm text-blue-600 dark:text-blue-400">
            <span>$0</span>
            <span>${((results.peakMRR * 12) / 1000000 * 100).toFixed(1)}% of $1M goal</span>
            <span>$1,000,000</span>
          </div>
        </div>
      </div>
