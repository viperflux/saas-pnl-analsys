...
export default function HybridPricingTable({
  monthlyData,
}: HybridPricingTableProps) {
      ...
      <div className="card">
        ...
        <div className="card-body">
          <div className="text-center py-8 text-gray-500 dark:text-gray-400">
            No hybrid pricing data available. Please configure your pricing
            model.
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg">
              ...
              <div className="text-xl font-bold text-orange-900 dark:text-orange-100">
                {formatCurrency(
                  monthlyData.reduce((sum, month) => sum + month.aiRevenue, 0),
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div>
                ...
                <div className="font-semibold text-gray-900 dark:text-gray-100">
                  {monthlyData[0]?.tenants} →{" "}
                  {monthlyData[monthlyData.length - 1]?.tenants}(
                  {(
                    ((monthlyData[monthlyData.length - 1]?.tenants || 0) /
                      (monthlyData[0]?.tenants || 1) -
                      1) *
                    100
                  ).toFixed(1)}
                  %)
              ...
              <div>
                ...
                <div className="font-semibold text-gray-900 dark:text-gray-100">
                  ...
                  {formatCurrency(
                    monthlyData[monthlyData.length - 1]?.totalRevenue || 0,
                  )}
                </div>
              </div>
              <div>
