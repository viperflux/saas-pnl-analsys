...
export async function verifyTokenEdgeCompat(token: string): Promise<AuthPayload | null> {
  try {
...
export async function authenticate(credentials: LoginCredentials): Promise<{ user: User; token: string } | null> {
